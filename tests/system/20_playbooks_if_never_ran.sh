...
ANSIBLE_CHECK_HISTORY_FILE="$__temp_filepath"
export ANSIBLE_CHECK_HISTORY_FILE
testlib::assert_exits_successfully 'History file exists' '[ -f "$ANSIBLE_CHECK_HISTORY_FILE" ]'
testlib::assert_exits_successfully 'History file is empty' '[ ! -s "$ANSIBLE_CHECK_HISTORY_FILE" ]'
...
testlib::assert_exits_successfully 'History file exists' '[ -f "$ANSIBLE_CHECK_HISTORY_FILE" ]'
testlib::assert_exits_successfully 'History file should no longer be empty' '[ -s "$ANSIBLE_CHECK_HISTORY_FILE" ]'
testlib::assert_exits_successfully 'History file contains first playbook' grep -F trivial.yml "$ANSIBLE_CHECK_HISTORY_FILE"
...
testlib::assert_exits_successfully 'History file exists' '[ -f "$ANSIBLE_CHECK_HISTORY_FILE" ]'
testlib::assert_exits_successfully 'History file is not empty' '[ -s "$ANSIBLE_CHECK_HISTORY_FILE" ]'
testlib::assert_exits_successfully 'History file contains second playbook' grep -F trivial_plus_ping_role.yml "$ANSIBLE_CHECK_HISTORY_FILE"
